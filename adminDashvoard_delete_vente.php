...
<?php
                                        ...
                                        if(isset($_POST['submit-button-delete'])) {
                                            
                                            try{
                                                $code_vente = $_POST['code_vente'];
                                                $sqlQuery = "DELETE FROM  vente WHERE code_vente='$code_vente'";
                                                $requete = $db->prepare($sqlQuery);
                                                $requete->execute();
                                            }catch (Exception $e) {
                                                die('Erreur : ' . $e->getMessage());
...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
    ...
    <div class="h-screen flex-grow-1 overflow-y-lg-auto">
            ...
            <div class="container-fluid">
                <div class="mb-npx">
                    ...
                    <li class="nav-item ">
                        ...
                        <li class="nav-item">
                            <a href="adminDashboard_vente.php" class="nav-link font-regular active">Vente</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="booking-form" id="review">
                ...
                <h2 class="text-center mb-lg-3 mb-2">Delete Vente</h2>
            
                <div class="containerL">
                    <form role="form" action="adminDashvoard_delete_vente.php" method="post">
                        <div class="row">
                            <div class="col-lg-6 col-5 mx-auto">
                                <input type="text" name="code_client" id="code_client"  class="form-control" placeholder="Code client" required>
                            ...
                            <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                 <button type="submit" class="form-control" id="submit-button-delete" name="submit-button-delete">Delete</button>
                            </div>
                        </div>
                    </form>
                </div>
