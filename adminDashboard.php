        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="sidebarCollapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">
                            <i class="bi bi-bookmarks">Collection</i>a
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">
                ...
                <div class="mb-npx">
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-6 col-12 text-sm-end">
                            <div class="mx-n1">
                                <a href="adminDashvoard_edit_med.php" class="btn  btn-sm btn-neutral border-base mx-1">
                                    <span class=" pe-2">
                                        <i class="bi bi-pencil"></i>
                                    </span>
                                    <span>Edit</span>
                                </a>
                                <a href="adminDashvoard_ajouter_med.php" class="btn  btn-sm btn-primary mx-1">
                                    <span class=" pe-2">
                                        <i class="bi bi-plus"></i>
                                    </span>
                                    <span>Create</span>
                                </a>
                                <a href="adminDashvoard_delete_med.php" class="btn  btn-sm btn-danger mx-1">
                                    <span class=" pe-2">
