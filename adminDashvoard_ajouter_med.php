...
<?php
                                        ...
                                        if(isset($_POST['submit-button-ajouter'])) {
                                            // Retrieve form data
                                            try{
                                                ...
                                                $sqlQuery = "INSERT INTO medicament(description,prix_unitaire,treatedFor) values('$description','$prix_unitaire','$treatedFor')";
                                                $requete = $db->prepare($sqlQuery);
                                                $requete->execute();
                                            }catch (Exception $e) {
                                                die('Erreur : ' . $e->getMessage());
...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
    ...
    <div class="h-screen flex-grow-1 overflow-y-lg-auto">
        ...
        <div class="booking-form" id="review">
                ...
                <h2 class="text-center mb-lg-3 mb-2">Ajouter Medicament</h2>
            
                <div class="containerL">
                    <form role="form" action="adminDashvoard_ajouter_med.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                 <button type="submit" class="form-control btn btn-succes" id="submit-button-ajouter" name="submit-button-ajouter">Ajouter</button>
                            </div>
                        </div>
                    </form>
                </div>
