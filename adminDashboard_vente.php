                ...
                <div class="row align-items-center">
                        ...
                        <div class="col-sm-6 col-12 text-sm-end">
                            <div class="mx-n1">
                                ...
                                <a href="adminDashvoard_delete_vente.php" class="btn  btn-sm btn-danger mx-1">
                                    <span class=" pe-2">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="card shadow border-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <span class="h6 font-semibold text-muted text-sm d-block mb-2">Vent</span>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-nowrap">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col">code_vente</th>
                                    <th scope="col">Nom Client</th>
                                    <th scope="col">Date Naissance Client</th>
                                    <th scope="col">Email Client</th>
                                    <th scope="col">CIN Client</th>
                                    <th scope="col">Adress Client</th>
                            ...
                            <tbody>
                                ...
                                try {
                                    $sqlQuery = "select * from vente as v ,client as c,medicament as m where v.id_client=c.code_client and v.code_medicament=m.code_medicament";
                                    $requete = $db->prepare($sqlQuery);
                                    $requete->execute();
                                    $res = $requete->fetchAll();
