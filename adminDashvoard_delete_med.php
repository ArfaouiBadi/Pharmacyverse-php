...
<?php
                                        ...
                                        if(isset($_POST['submit-button-delete'])) {
                                            ...
                                            try{
                                                ...
                                                $sqlQuery = "DELETE FROM  medicament WHERE code_medicament='$code_medicament'";
                                                $requete = $db->prepare($sqlQuery);
                                                $requete->execute();
                                            }catch (Exception $e) {
                                                die('Erreur : ' . $e->getMessage());
...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
    ...
    <div class="h-screen flex-grow-1 overflow-y-lg-auto">
        ...
        <div class="booking-form" id="review">
                ...
                <h2 class="text-center mb-lg-3 mb-2">Delete Medicament</h2>
            
                <div class="containerL">
                    <form role="form" action="adminDashvoard_delete_med.php" method="post">
                        <div class="row">
                            <div class="col-lg-6 col-5 mx-auto">
                                <input type="text" name="code_medicament" id="code_medicament"  class="form-control" placeholder="Code Medicament" required>
